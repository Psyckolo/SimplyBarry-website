  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10 text-center px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">Donnez vie à votre espace vert avec Simply Barry</p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href="#contact"
            className="btn bg-primary hover:bg-secondary text-white px-8 py-3 rounded-md text-lg font-semibold transition-all"
          >

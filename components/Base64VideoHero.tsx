...
export default function Base64VideoHero() {
  // Cette approche n'est recommandée que pour de très petites vidéos
  // Normalement, vous convertiriez votre vidéo en base64 et la placeriez ici
  const [videoError, setVideoError] = useState(false)

  // Exemple de début d'une chaîne base64 (à remplacer par votre vidéo complète)
  const videoBase64 = "data:video/mp4;base64,AAAAIGZ0eXBpc29tAAACAGlzb21pc28yYXZjMW1wNDEAAAAIZnJlZQAAA..."

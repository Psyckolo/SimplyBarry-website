      ...
      <div className="absolute inset-0 w-full h-full">
        {!videoError && !isLoading && (
          <video
            ...
            preload="auto"
          >
            {/* Utiliser une version très optimisée de la vidéo (moins de 2-3 Mo) */}
            <source src="/videos/garden-optimized.mp4" type="video/mp4" />
            <source src="/videos/garden-optimized.webm" type="video/webm" />
          </video>
        )}

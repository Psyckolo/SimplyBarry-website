      ...
      <div className="absolute inset-0 w-full h-full">
        {isMounted ? (
          <div className="absolute inset-0 w-full h-full pointer-events-none">
            <iframe
              src="https://www.youtube.com/embed/Ow7YEWRLcSw?autoplay=1&mute=1&controls=0&showinfo=0&rel=0&loop=1&playlist=Ow7YEWRLcSw&modestbranding=1&iv_load_policy=3&disablekb=1&playsinline=1&enablejsapi=1"

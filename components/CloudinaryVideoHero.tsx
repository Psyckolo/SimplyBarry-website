...
export default function CloudinaryVideoHero() {
  const [videoError, setVideoError] = useState(false)
  // Nouvelle URL Cloudinary
  const videoUrl = "https://res.cloudinary.com/dh52kmuhc/video/upload/v1745880132/4383263-hd_1920_1080_30fps_oqnvrd.mp4"
